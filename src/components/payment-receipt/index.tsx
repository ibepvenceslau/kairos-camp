...
export const PaymentReceipt = ({ registration }: PaymentReceiptProps) => {
  return (
    <div className="relative bg-gray-950 ring-2 ring-rose-600  rounded-lg p-8 mt-5">
      ...
      <h2 className="text-3xl font-semibold">Comprovante de Inscrição</h2>
      ...
      <div className="flex flex-col gap-2 mt-6">
        ...
        <div className="flex flex-col md:gap-2 md:flex-row">
          <label className="text-sm text-rose-600 font-bold">RG:</label>
          <p>{registration.rg}</p>
        </div>
        <div className="flex flex-col md:gap-2 md:flex-row">
          <label className="text-sm text-rose-600 font-bold">CPF:</label>
          <p>{registration.cpf}</p>
        </div>
        <div className="flex flex-col md:gap-2 md:flex-row">
